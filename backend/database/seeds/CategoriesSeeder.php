...
class CategoriesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['id'=>2,'name'=>'Speakers','slug'=>'speakers','parent_id'=>NULL,'type'=>'group','ord'=>200,'lvl'=>0,'description'=>'Powerful performance. Versatile designs. For all your music, movies, and tv — at home or on the go.'],
            ...
            ['id'=>11,'name'=>'Portable','slug'=>'portable','parent_id'=>2,'type'=>'product','ord'=>201,'lvl'=>1,'description'=>'Engineered to travel, but sound great in your home. With durable designs and impressive battery life, you can bring them wherever music takes you.'],
