...
@NgModule({
  declarations: [
    AppComponent,                 HeaderComponent,              HeaderLanguageComponent,   HeaderCurrencyComponent,    HeaderToplinksComponent,
    HeaderSearchboxComponent,     HeaderTopcartComponent,       HeaderNavigationComponent, HeaderLogoComponent,        HeaderCultureComponent,
    SliderComponent,              ProductHotComponent,          ProductItemComponent,      ProductsNewComponent,       FooterComponent,
    ProductsBestsellersComponent, ProductItemDivComponent,      BannerMidComponent,        ProductsFeaturedComponent,  MobileMenuComponent,
    ProductsLatestComponent,      NavMenuitemSimpleComponent,   NavMenuitemWideComponent,  NavMenuitemLargeComponent,  NavMenuitemWide4Component,
    CompanySidemenuComponent,     CompanySidemenuLinkComponent, CategoriesComponent,       MycartComponent,            ShopbyComponent,
    CustomSliderComponent,        CompareWidgetComponent,       SearchByTagsComponent,     SidebarComponent,           CatsliderComponent,
